...
The current skill set contains seven anchor skills under `plugins/phd-research/skills/`: `idea-evaluator`, `vibe-research-workflow`, `intro-drafter`, `tech-paper-template`, `benchmark-paper-template`, `figure-designer`, `pre-submission-reviewer`. Adding a new skill requires:
